...
describe("NativeFallbackDecoder", () => {
  describe("decode()", () => {
    it("should decode a unknown decodable to its address as string", () => {
      ...
      expect(decoder.decode(ptr(0x12345678))).toEqual({ declaredType: "customStructType", value: "0x12345678" });
    });
    ...
    it("should decode a unknown named decodable to its address as string", () => {
      ...
      expect(decoder.decode(ptr(0x12345678))).toEqual({ declaredType: "customStructType", name: "customStructName", value: "0x12345678" });
    });
  });
});
