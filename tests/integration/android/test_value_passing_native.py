...
class TestValuePassingNative:
            ...
            "hookCollection": [
                {
                    "module": MODULE_VALUE,
                    "hooks": [
                        {"symbol": "receive_bool", "retType": "bool", "params": [["bool", "minValue"], ["bool", "maxValue"]]},
                        # declared as "char" (by value): NativeValueDecoder treats it as a signed byte, not a C string.
                        {"symbol": "receive_char", "retType": "char", "params": [["char", "minValue"], ["char", "maxValue"]]},
                        {"symbol": "receive_short", "retType": "short", "params": [["short", "minValue"], ["short", "maxValue"]]},
                        {"symbol": "receive_int", "retType": "int", "params": [["int", "minValue"], ["int", "maxValue"]]},
                        {
                            "symbol": "receive_uint",
                            "retType": "unsigned int",
                            "params": [["unsigned int", "minValue"], ["unsigned int", "maxValue"]],
                        },
                    ],
                }
            ]
            ...
            "hookCollection": [
                {
                    "module": MODULE_VALUE,
                    "hooks": [
                        {"symbol": "receive_long", "retType": "long", "params": [["long", "minValue"], ["long", "maxValue"]]},
                        {
                            "symbol": "receive_llong",
                            "retType": "long long",
                            "params": [["long long", "minValue"], ["long long", "maxValue"]],
                        },
                        {"symbol": "receive_float", "retType": "float", "params": [["float", "minValue"], ["float", "maxValue"]]},
                        {"symbol": "receive_double", "retType": "double", "params": [["double", "minValue"], ["double", "maxValue"]]},
                    ],
                }
            ]
        }
    ...
    def test_by_reference_fundamental_types(self, run_frooky, count_matched_events):
            ...
            "hookCollection": [
                {
                    ...
                    "hooks": [
                        {"symbol": "receive_bool_ref", "params": [["bool *", "minValue"], ["bool *", "maxValue"]]},
                        {"symbol": "receive_schar_ref", "params": [["int8 *", "minValue"], ["int8 *", "maxValue"]]},
                        {"symbol": "receive_uchar_ref", "params": [["uint8 *", "minValue"], ["uint8 *", "maxValue"]]},
                        {"symbol": "receive_short_ref", "params": [["short *", "minValue"], ["short *", "maxValue"]]},
                        {"symbol": "receive_int_ref", "params": [["int *", "minValue"], ["int *", "maxValue"]]},
                        {"symbol": "receive_float_ref", "params": [["float *", "minValue"], ["float *", "maxValue"]]},
                        {"symbol": "receive_double_ref", "params": [["double *", "minValue"], ["double *", "maxValue"]]},
                    ],
                }
            ]
        }
                    ...
                    "hooks": [
                        {
                            ...
                            "params": [["unsigned char *", "data", {"direction": "inout"}], ["int", "length"]],
                        }
                    ],
                }
            ]
            ...
            "hookCollection": [
                {
                    ...
                    "hooks": [
                        {"symbol": "receive_cstring", "retType": "char *", "params": [["char *", "s"]]},
                        {"symbol": "receive_utf8", "retType": "char *", "params": [["char *", "s"]]},
                    ],
                }
            ]
        }
    ...
    def test_short_form_hook_without_decoding(self, run_frooky, count_matched_events):
        ...
        """
        hook_file = {"hookCollection": [{"module": MODULE_VALUE, "hooks": ["receive_ldouble"]}]}
    ...
    def test_short_form_with_decoder_settings_tuple(self, run_frooky, count_matched_events):
        ...
        hook_file = {"hookCollection": [{"module": MODULE_VALUE, "hooks": [["receive_int", {"fastDecode": True}]]}]}
    ...
    def test_stack_trace_limit(self, run_frooky, find_matched_events):
        ...
        """
        limit = 5
        hook_file = {"hookCollection": [{"module": MODULE_VALUE, "hookSettings": {"stackTraceLimit": limit}, "hooks": ["receive_int"]}]}
    ...
    def test_stack_trace_filter_keeps_event_when_a_frame_matches(self, run_frooky, count_matched_events):
        ...
        hook_file = {
            "hookCollection": [
                {
                    "module": MODULE_VALUE,
                    "hookSettings": {"stackTraceLimit": 10, "stackTraceFilter": ["^org\\.owasp\\.mastestapp"]},
                    "hooks": ["receive_int"],
                }
            ]
        }
    ...
    def test_stack_trace_filter_drops_event_when_no_frame_matches(self, run_frooky, count_matched_events):
        ...
        hook_file = {
            "hookCollection": [
                {
                    "module": MODULE_VALUE,
                    "hookSettings": {"stackTraceLimit": 10, "stackTraceFilter": ["^this\\.matches\\.nothing"]},
                    "hooks": ["receive_int"],
                }
            ]
        }
